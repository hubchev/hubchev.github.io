...
\date{Last compiled on 22 March, 2024}
...
## 1   AFE 2022 1.185138e+12 NY.GDP.MKTP.CD GDP (current US$)    ZH
## 2   AFE 2021 1.086531e+12 NY.GDP.MKTP.CD GDP (current US$)    ZH
## 3   AFE 2020 9.288802e+11 NY.GDP.MKTP.CD GDP (current US$)    ZH
##                       country
...
## Rows: 13,198
## Columns: 7
## $ iso3c       <chr> "AFE", "AFE", "AFE", "AFE", "AFE", "AFE", "AFE"~
## $ date        <chr> "2022", "2021", "2020", "2019", "2018", "2017",~
## $ value       <dbl> 1.185138e+12, 1.086531e+12, 9.288802e+11, 1.006~
## $ indicatorID <chr> "NY.GDP.MKTP.CD", "NY.GDP.MKTP.CD", "NY.GDP.MKT~
## $ indicator   <chr> "GDP (current US$)", "GDP (current US$)", "GDP ~
## $ iso2c       <chr> "ZH", "ZH", "ZH", "ZH", "ZH", "ZH", "ZH", "ZH",~
## $ country     <chr> "Africa Eastern and Southern", "Africa Eastern ~
\end{verbatim}
...
\begin{verbatim}
##     iso3c               date               value          
##  Length:13198       Length:13198       Min.   :8.825e+06  
##  Class :character   Class :character   1st Qu.:2.435e+09  
##  Mode  :character   Mode  :character   Median :1.786e+10  
##                                        Mean   :1.224e+12  
##                                        3rd Qu.:2.264e+11  
##                                        Max.   :1.009e+14  
##  indicatorID         indicator            iso2c          
...
## $ horsepower <dbl> 110, 110, 93, 110, 175, 105, 245, 62, 95, 123, 1~
...
##         <dbl>       <dbl> <chr>         <fct>      <lgl>      
## 1           1         1.1 apple         red        TRUE       
## 2           2         2.2 banana        yellow     TRUE       
## 3           3        NA   orange        red        TRUE       
## 4           4         4.4 cherry        blue       FALSE      
## 5           5         5.5 grape         green      TRUE       
## # i 1 more variable: date_var <date>
\end{verbatim}
...
\begin{verbatim}
##   integer_var  numeric_var    character_var       factor_var
##  Min.   :1    Min.   :1.100   Length:5           blue  :1   
##  1st Qu.:2    1st Qu.:1.925   Class :character   green :1   
##  Median :3    Median :3.300   Mode  :character   red   :2   
##  Mean   :3    Mean   :3.300                      yellow:1   
##  3rd Qu.:4    3rd Qu.:4.675                                 
##  Max.   :5    Max.   :5.500                                 
##               NA's   :1                                     
##  logical_var        date_var         
##  Mode :logical   Min.   :2022-01-01  
##  FALSE:1         1st Qu.:2022-02-01  
##  TRUE :4         Median :2022-03-01  
##                  Mean   :2022-03-02  
##                  3rd Qu.:2022-04-01  
##                  Max.   :2022-05-01  
## 
...
## $ date_var      <date> 2022-01-01, 2022-02-01, 2022-03-01, 2022-04-0~
\end{verbatim}
...
\begin{verbatim}
##  cyl 52 62 65 66 91 93 95 97 105 109 110 113 123 150 175 180 205 215
...
##    <chr>       <chr>                   <chr>       <dbl>        <int>
##  1 Bonn        City with County Rights Nordrhei~  305765            3
##  2 Bonn        City with County Rights Nordrhei~  305765            3
##  3 Bonn        City with County Rights Nordrhei~  305765            3
##  4 Brühl       Commune                 Baden-Wü~   13805            2
##  5 Brühl       City                    Nordrhei~   43568            2
##  6 Erbach      City                    Baden-Wü~   13024            2
##  7 Erbach      City                    Hessen      13245            2
##  8 Fürth       City with County Rights Bayern     115613            2
##  9 Fürth       Commune                 Hessen      10481            2
## 10 Lichtenau   City                    Nordrhei~   10473            2
## 11 Lichtenau   Commune                 Sachsen      7544            2
## 12 Münster     Commune                 Hessen      14071            2
## 13 Münster     City with County Rights Nordrhei~  289576            2
## 14 Neunkirchen Commune                 Nordrhei~   13930            2
## 15 Neunkirchen City                    Saarland    46172            2
## 16 Neuried     Commune                 Baden-Wü~    9383            2
## 17 Neuried     Commune                 Bayern       8277            2
## 18 Petersberg  Commune                 Hessen      14766            2
## 19 Petersberg  Commune                 Sachsen-~   10097            2
## 20 Senden      City                    Bayern      21560            2
## 21 Senden      Commune                 Nordrhei~   19976            2
## 22 Staufenberg City                    Hessen       8114            2
## 23 Staufenberg Commune                 Niedersa~    7983            2
\end{verbatim}
...
##  [1] dplyr_1.1.4      jtools_2.2.2     sjPlot_2.8.15   
##  [4] ggpubr_0.6.0     datasauRus_0.1.8 haven_2.5.4     
##  [7] janitor_2.2.0    wbstats_1.0.4    scales_1.3.0    
## [10] lubridate_1.9.3  forcats_1.0.0    purrr_1.0.2     
## [13] readr_2.1.4      tidyr_1.3.0      tibble_3.2.1    
## [16] ggplot2_3.5.0    tidyverse_2.0.0  stringr_1.5.1   
## [19] bundesligR_0.1.0 captioner_2.2.3  knitr_1.45      
## [22] pacman_0.5.1    
## 
## loaded via a namespace (and not attached):
##   [1] minqa_1.2.6         TH.data_1.1-2       colorspace_2.1-0   
##   [4] ggsignif_0.6.4      class_7.3-22        rsconnect_1.2.0    
##   [7] sjlabelled_1.2.0    estimability_1.4.1  snakecase_0.11.1   
##  [10] rstudioapi_0.15.0   listenv_0.9.0       farver_2.1.1       
##  [13] bit64_4.0.5         prodlim_2023.08.28  fansi_1.0.6        
##  [16] mvtnorm_1.2-4       codetools_0.2-19    splines_4.2.2      
##  [19] cachem_1.0.8        sjmisc_2.8.9        jsonlite_1.8.8     
##  [22] nloptr_2.0.3        ggeffects_1.3.4     broom_1.0.5        
##  [25] compiler_4.2.2      httr_1.4.7          sjstats_0.18.2     
##  [28] emmeans_1.9.0       backports_1.4.1     Matrix_1.6-4       
##  [31] fastmap_1.1.1       cli_3.6.2           htmltools_0.5.7    
##  [34] tools_4.2.2         coda_0.19-4         gtable_0.3.4       
##  [37] glue_1.6.2          tinytex_0.49        Rcpp_1.0.11        
##  [40] carData_3.0-5       jquerylib_0.1.4     vctrs_0.6.5        
##  [43] nlme_3.1-164        insight_0.19.7      timeDate_4032.109  
##  [46] gower_1.0.1         xfun_0.41           globals_0.16.2     
##  [49] lme4_1.1-35.1       timechange_0.2.0    lifecycle_1.0.4    
##  [52] rstatix_0.7.2       future_1.33.1       zoo_1.8-12         
##  [55] MASS_7.3-60         ipred_0.9-14        vroom_1.6.5        
##  [58] ragg_1.2.7          hms_1.1.3           sandwich_3.1-0     
##  [61] parallel_4.2.2      yaml_2.3.8          curl_5.2.0         
##  [64] pander_0.6.5        sass_0.4.8          rpart_4.1.23       
##  [67] stringi_1.8.3       highr_0.10          bayestestR_0.13.1  
##  [70] boot_1.3-28.1       hardhat_1.3.0       lava_1.7.3         
##  [73] rlang_1.1.2         pkgconfig_2.0.3     systemfonts_1.0.5  
##  [76] evaluate_0.23       lattice_0.22-5      recipes_1.0.9      
##  [79] labeling_0.4.3      bit_4.0.5           tidyselect_1.2.0   
##  [82] parallelly_1.36.0   magrittr_2.0.3      bookdown_0.37      
##  [85] R6_2.5.1            generics_0.1.3      multcomp_1.4-25    
##  [88] mgcv_1.9-1          pillar_1.9.0        withr_2.5.2        
##  [91] survival_3.5-7      abind_1.4-5         nnet_7.3-19        
##  [94] future.apply_1.11.1 performance_0.10.8  modelr_0.1.11      
##  [97] crayon_1.5.2        car_3.1-2           utf8_1.2.4         
## [100] tzdb_0.4.0          rmarkdown_2.25      grid_4.2.2         
## [103] data.table_1.14.10  digest_0.6.33       xtable_1.8-4       
## [106] textshaping_0.3.7   munsell_0.5.0       bslib_0.6.1
\end{verbatim}
