...
\date{Last compiled on 04 May, 2023}
...
\hypertarget{key-guidelines-on-working-with-r}{%
\section{Key guidelines on working with R}\label{key-guidelines-on-working-with-r}}
...
\begin{verbatim}
## [1] -2.216407397 -1.024432890 -0.462035460 -0.004008021 -0.663588378 -1.951928221 -4.074541935 -0.187535124
## [9] -0.097612829
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# defining multiple vectors}
...
\hypertarget{rdata-files}{%
\section{RData files}\label{rdata-files}}

You can save some of your objects (\texttt{save()}) or all (\texttt{save.image()}) and load data stored in the \texttt{.RData} (\texttt{load()}) format easily. With \texttt{rm()} you remove objects from your workspace. and with \texttt{rm(list\ =\ ls())} you clear all objects from the workspace. When you delete an object in R, you cannot recover it by clicking some \emph{Undo button}.

\hypertarget{import-other-file-formats}{%
\section{Import other file formats}\label{import-other-file-formats}}
